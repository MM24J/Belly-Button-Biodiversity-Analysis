...
function buildMetadata(sample) {
    ...
    d3.json(url).then((data) => {
        ...
        // Use Object.entries to add each key/value pair from the metadata JSON object
...
function buildBarChart(sample) {
    ...
    d3.json(url).then((data) => {
        ...
        // Use slice to display the top ten items in descending order
...
function buildBubbleChart(sample) {
    ...
    d3.json(url).then((data) => {
        ...
        // Set up the layout
        let layout = {
            title: "Concentration of Samples",
            hovermode: "closest",
            xaxis: {title: "OTU ID"},
        };
